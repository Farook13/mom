...
# Bot images & videos
PICS = (environ.get('PICS', 'https://envs.sh/Mll.jpg')).split()
NOR_IMG = environ.get("NOR_IMG", "https://telegra.ph/file/0593a3103ba1b9a5855bf.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://envs.sh/Mkp.mp4")
...
SUPPORT_CHAT_ID = "cine_flix01"
NO_RESULTS_MSG = bool(environ.get("NO_RESULTS_MSG", False))

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://death:death@cluster0.evhwgcz.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002293430482')).split()]
